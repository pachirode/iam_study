...
readonly CERT_HOSTNAME="${CERT_HOSTNAME:-iam.api.pachirode.com},127.0.0.1,localhost"
...
EOF
  ...
  echo '{"CN":"'"${prefix}"'","hosts":[],"key":{"algo":"rsa","size":2048},"names":[{"C":"CN","ST":"Shanghai","L":"Shanghai","O":"pachirode","OU":"'"${prefix}"'"}]}' \
